  ...
  return (
    <div className={`flex flex-col gap-4 items-start w-full ${className}`}>
      ...
      <div className="flex gap-0.5 items-center px-1.5 w-full">
        <h2
          className="text-[#ff336d] text-[24px] font-bold leading-[100%] whitespace-nowrap overflow-hidden text-ellipsis"
      ...
      >
        ...
        <div className="flex gap-0.5 items-center px-1.5 w-full">
          <p
            className="text-[#f6f6f6] text-[14px] font-normal leading-[100%] flex-1"
